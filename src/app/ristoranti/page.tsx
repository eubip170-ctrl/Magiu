...
import { getRestaurants } from "@/lib/restaurants-store";
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      ...
      {restaurants.length === 0 ? (
        <p className="mt-12 rounded-2xl border border-border bg-card p-8 text-center text-muted">
          Ancora nessun ristorante. Aggiungine uno dalla pagina{" "}
          <Link href="/gestione" className="text-brand hover:underline">
            Gestisci
          </Link>
          .
        </p>
